...
const nativeFunction = `
  ...
  let postMessage = window.parent.postMessage;
    ...
    window.location.hash = '&executeFunction<-' + fnName + '&' + '&arguments<-' + JSON.stringify(args) + '&' + postMessage(JSON.stringify(args)) + '&';
  }
`;
const js = `var SignaturePad = (function (document) {
  "use strict";
...
const application = (penColor: any, backgroundColor: any, dataURL: any) => `
